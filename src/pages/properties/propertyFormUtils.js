export const INITIAL_FORM = {
  ...
  latitude: '',
  longitude: '',
  show_exact_location_publicly: true,
  bedrooms: 1,
  bathrooms: 1,
  floors: 1,
  land_area_value: '',
...
export function buildPropertyPayload(form) {
  ...
  return {
    ...
    rent_period: ['rent', 'lease'].includes(form.purpose) ? (form.rent_period || 'month') : null,
    ...
    show_exact_location_publicly: form.show_exact_location_publicly !== false,
...
export function propertyToForm(property) {
  return {
    ...
    show_exact_location_publicly: property.show_exact_location_publicly !== false,

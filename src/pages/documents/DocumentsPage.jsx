...
export default function DocumentsPage() {
  ...
  return <CrudPage resource="documents" title="Documents" description="Securely organize identity, ownership, contract, receipt, floor-plan, lead, and transaction documents." fields={fields} columns={[{ key: 'title', label: 'Document' }, { key: 'category', label: 'Category' }, { key: 'lead_name', label: 'Lead' }, { key: 'uploaded_by_name', label: 'Uploaded by' }, { key: 'is_customer_visible', label: 'Customer visible' }, { key: 'created_at', label: 'Uploaded', type: 'date' }]} />
}

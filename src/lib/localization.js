...
export const TRANSLATIONS = {
  ne: {
    ...
    'Social Media': 'सामाजिक सञ्जाल', 'Website Studio': 'वेबसाइट स्टुडियो', 'Web Submissions': 'वेब अनुरोधहरू', 'Agent Reviews': 'एजेन्ट समीक्षा', Reports: 'रिपोर्ट', Analytics: 'विश्लेषण',
    ...
    'Agency settings': 'एजेन्सी सेटिङ', 'Organization settings': 'संस्था सेटिङ', 'Save changes': 'परिवर्तन सुरक्षित गर्नुहोस्', 'Save agency settings': 'एजेन्सी सेटिङ सुरक्षित गर्नुहोस्', 'Save organization settings': 'संस्था सेटिङ सुरक्षित गर्नुहोस्',
    'Agency profile': 'एजेन्सी प्रोफाइल', 'Organization profile': 'संस्था प्रोफाइल', 'Office location': 'कार्यालय स्थान', Location: 'स्थान', 'Public website': 'सार्वजनिक वेबसाइट', 'Social and messaging': 'सामाजिक सञ्जाल र सन्देश', 'Brand media': 'ब्रान्ड सामग्री',
    Localization: 'स्थानीयकरण', 'Workspace localization': 'कार्यस्थान स्थानीयकरण', 'Default interface language': 'पूर्वनिर्धारित भाषा', 'Default date system': 'पूर्वनिर्धारित मिति प्रणाली',
